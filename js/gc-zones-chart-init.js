...
function gcGetBaseURL() {
    ...
    let scriptURL = document.getElementById("gc-zones-chart-init");
...
function initComponent() {
    ...
    */
    ...
    // change for DEBUG to js/gc-zones-chart.js
    loadJSscript("js/gc-zones-chart.js", function() {
        ...
        vmRoot = new Vue({
            ...
            i18n: i18n,
            created() {
              console.debug("gc-zones-chart-init created!");
...
function loadJSscript (url, callback) {
    /* 
      ...
      */
    console.debug("gc-zones-chart-init - loadJSscript()");
    let script = document.createElement("script");  // create a script DOM node
    script.type = 'text/javascript';
